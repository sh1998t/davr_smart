...
class PadDialogHistoriyScreen extends StatefulWidget {
  final int? depositId;
  final String? login;
  ...
  @override
  State<PadDialogHistoriyScreen> createState() =>
      _ShowDialogDepositScreenState();
}

class _ShowDialogDepositScreenState extends State<PadDialogHistoriyScreen> {
