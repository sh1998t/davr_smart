...
class PadDialogSubmittedDepositScreen extends StatefulWidget {
  final int? depositId;
  final String? login;
  ...
  final double? height;
  const PadDialogSubmittedDepositScreen({
    super.key,
  ...
  @override
  State<PadDialogSubmittedDepositScreen> createState() =>
      _PadDialogSubmittedDepositScreen();
}

class _PadDialogSubmittedDepositScreen
    extends State<PadDialogSubmittedDepositScreen> {
