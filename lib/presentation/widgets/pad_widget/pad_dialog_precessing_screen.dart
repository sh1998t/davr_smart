...
class PadDialogPrecessingScreen extends StatefulWidget {
  const PadDialogPrecessingScreen(
      {super.key,
      this.depositId,
      this.login,
      this.statusName,
  ...
  @override
  State<PadDialogPrecessingScreen> createState() =>
      _PadDialogPrecessingScreenState();
}

class _PadDialogPrecessingScreenState extends State<PadDialogPrecessingScreen> {
